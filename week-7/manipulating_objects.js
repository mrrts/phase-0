...
// It took a moment to figure out the syntax for adding the individual children to the children object as 
// it was adding an object to an object. I was stuck in the array mindset, trying to use the push method, but
// eventually realized that I could just add the new property with another chained dot and set its value to the empty object.


// --- How difficult was it to add and delete properties outside of the object itself?

// It wasn't difficult at all as the dot syntax is very intuitive, and this entire principle is something we've already
// done in Ruby. 


// --- What did you learn about manipulating objects in this challenge?

// I had to research to find the "delete" operator to remove a property from an object, and I also can begin to imagine
// how useful it will be to have objects reference each other, like when we set the adam.children property as equal to the 
// terah.children property. This is representative of the many real-world situations requiring related objects. I would
// expect that in this particular instance it would be best to programatically test for the spouse relationship and then share 
// the children property based on that test.
